                        ...
                        <div className=" tracking-container hide-scroolbar p-3" style={{ marginTop: '8rem', marginBottom: '5rem', height: '60vh', background: '#f8f9fa', maxWidth: '400px', overflow: 'auto' }}>
                            ...
                            <div className='card border-0 p-3 rounded mb-3'>
                                ...
                                <div className='d-flex gap-3 mb-1'>
                                    ...
                                    <p className='text-start'>New Delhi, India<br /><span className="form-text">nangloi</span></p>
                                </div>
                                <div className='d-flex gap-3 mb-2'>
                                    <div><FaLink style={{ fontSize: '1rem' }} /></div>
                                    <div><a href='https://meet.google.com/udx-kieq-sng' target='_blank' rel='noreferrer'>click to join meeting</a></div>
                                </div>
