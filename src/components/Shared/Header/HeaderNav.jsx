...
const HeaderNav = ({ open, setOpen, isLoggedIn, data, avatar, content, userRole }) => {
        ...
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    ...
                    {!notAllowdedDoctor.includes(userRole) && <li><NavLink to={'/doctors'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Doctors</NavLink></li>}
            ...
            >
                <ul className="mobile-menu-nav">
                    ...
                    {!notAllowdedDoctor.includes(userRole) && <li><NavLink to={'/doctors'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaUserMd className="icon" />Doctors</NavLink></li>}
